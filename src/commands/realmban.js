    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('gamertag')
                .setDescription('The Xbox Gamertag of the player to ban')
                .setRequired(true)),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const selectMenu = new StringSelectMenuBuilder()
                .setCustomId(`realmban_${xuid}_${gamertag}`)
                .setPlaceholder('Select a Realm to ban the player from')
                .addOptions(
            ...
            const selectEmbed = new EmbedBuilder()
                ...
                .setDescription(`Select which Realm to ban **${gamertag}** from.`)
                .setColor(0x5865F2)
                .addFields(
            ...
            const errorEmbed = new EmbedBuilder()
                ...
                .setDescription(error.message || 'Failed to process the ban request.')
                .setColor(0xFF0000)

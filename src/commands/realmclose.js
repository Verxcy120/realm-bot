    ...
    async execute(interaction) {
        ...
        try {
            ...
            const selectMenu = new StringSelectMenuBuilder()
                .setCustomId('realm_close')
                .setPlaceholder('Select a Realm to close')
                .addOptions(
            ...
            const selectEmbed = new EmbedBuilder()
                .setTitle(`${Emojis.Realms} Close Realm`)
                .setDescription('Select which Realm you want to **close**.\n\nClosing a Realm prevents players from joining.')
                .setColor(0xFF0000)

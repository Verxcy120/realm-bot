...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('realmbackup')
        .setDescription('View and restore backups for your Realm'),
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const selectMenu = new StringSelectMenuBuilder()
                .setCustomId('realm_backup_select')
                .setPlaceholder('Select a Realm to view backups')
                .addOptions(
            ...
            const selectEmbed = new EmbedBuilder()
                .setTitle(`${Emojis.Realms} Realm Backups`)
                .setDescription('Select which Realm you want to view **backups** for.\n\nYou can restore your Realm to a previous backup.')
                .setColor(0x5865F2)
